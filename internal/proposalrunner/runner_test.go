...
func TestRunnerGitLabModeCreatesMRAndComment(t *testing.T) {
	cfg := validConfig()
	...
	fake := &fakeCommandRunner{
		responses: []fakeResponse{
			{},
			{writeLastMessage: true, lastMessage: "Final GitLab response."},
			{stdout: "?? openspec/changes/add-gitlab/proposal.md\n"},
			{},
			{},
			{},
			{},
			{stdout: "https://gitlab.com/example/project/-/merge_requests/42\n"},
			{},
		},
	}
	...
	mrURL, err := runner.Run(context.Background(), ProposalInput{Title: "Add GitLab", AgentPrompt: "Add GitLab"})
	if err != nil {
		t.Fatalf("Run() returned error: %v", err)
	}
	if mrURL != "https://gitlab.com/example/project/-/merge_requests/42" {
		t.Fatalf("mrURL = %q", mrURL)
	}

	branchName := "codex/proposal/20260422100203-add-gitlab"
	assertCommand(t, fake.commands[7], "glab", []string{
		"mr", "create",
		"--source-branch", branchName,
		"--target-branch", "main",
		"--title", "OpenSpec proposal: Add GitLab",
		"--description", "Generated by orchv3 proposal runner.\n\nTask:\nAdd GitLab\n",
		"--yes",
	}, cloneDir)
	assertCommand(t, fake.commands[8], "glab", []string{
		"mr", "note", "create", "https://gitlab.com/example/project/-/merge_requests/42",
		"--message", "Final GitLab response.",
	}, cloneDir)
}
...
https://github.com/example/project/pull/42`,
		...
		{
			name: "gitlab merge request url in text",
			output: `Creating merge request for branch into main
https://gitlab.com/example/project/-/merge_requests/42`,
			want: "https://gitlab.com/example/project/-/merge_requests/42",
		},
	}
